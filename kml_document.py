...
template_kml_document = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><kml xmlns=\"http://www.opengis.net/kml/2.2\" xmlns:gx=\"http://www.google.com/kml/ext/2.2\" xmlns:kml=\"http://www.opengis.net/kml/2.2\" xmlns:atom=\"http://www.w3.org/2005/Atom\"><Document><name>{}</name>{}</Document></kml>"
template_kml_folder = "<Folder><name>{}</name>{}</Folder>"
template_kml_line = "<Placemark><name>{}</name><description>{}</description><styleUrl>{}</styleUrl><LineString><coordinates>{}</coordinates></LineString></Placemark>"
template_kml_point = "<Placemark><name>{}</name><description>{}</description><styleUrl>{}</styleUrl><Point><coordinates>{},{},0</coordinates></Point></Placemark>"
...
class kml_folder:
    ...
    def __str__(self):
        ...
        return template_kml_folder.format(self.name, children)
...
class kml_point:
    ...
    def __init__(self, name, description, longitude, latitude, label):
        self.name = name
        self.description = description
